    ...
    const fetchPriceData = async () => {
      try {
        const res = await fetch(
          "http://127.0.0.1:5000/api/data/agri?ticker=CORN%20-%20CHICAGO%20BOARD%20OF%20TRADE&column=ZC=F_Close"
        );
        ...
        <div data-theme="dark" data-neutral="gray" data-brand="violet">
          ...
          <div>
            ...
            {loadingPrice ? (
              ...
              <Chart
                data={priceData}
                title="Corn Close Prices (Last 3 Years)"
