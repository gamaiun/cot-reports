      ...
      <div className={classNames(styles.dropdownWrapper)}>
        ...
        <button
          ...
          style={{
            ...
            background: "var(--surface-color)", // Use a surface color from your theme
            border: "1px solid var(--neutral-medium-color)", // Add border
            borderRadius: "8px", // Add rounded corners
            color: "var(--neutral-strong-color)", // Use neutral strong color for text
            fontSize: "14px", // Set font size
            cursor: "pointer", // Show pointer cursor on hover
            display: "flex", // Use flex for better alignment
            alignItems: "center", // Center content vertically
            justifyContent: "space-between", // Add space between text and dropdown icon
